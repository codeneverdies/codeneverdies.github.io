---
layout: post
title:  "Land Of The PEB: Running from the debugger"
---
...
> ![registry-globalflag](/assets/images/LOTP2/registry-globalflag.png)
...
> ![x64dbg-attach](/assets/images/LOTP2/x64dbg-attach.png)
...
> ![ZERO-FLAG](/assets/images/LOTP2/ZERO-FLAG.png)
...
> ![0x1-Dump](/assets/images/LOTP2/0x1-Dump.png)
...
> ![Clean-ret](/assets/images/LOTP2/Clean-ret.png)
...
> ![anti-debugging-bypass1](/assets/images/LOTP2/anti-debugging-bypass1.png)

Click "Ok" and the value will change

> ![Changed](/assets/images/LOTP2/Changed.png)

The **BeingDebugged** value was changed to `0x0` (false)

> ![Done](/assets/images/LOTP2/Done.png)
